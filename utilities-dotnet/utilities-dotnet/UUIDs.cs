...
public enum ServiceTypes
{
    ...
    public static class UUIDs
    {
        ...
        public static Dictionary<AppSubcomponents, string> App = new() 
        {
        ...
        public static Dictionary<ClassTypes, string> Class = new() 
        {
        ...
        public static Dictionary<SchemaTypes, string> Schema = new() 
        {
        ...
        public static Dictionary<ServiceTypes, string> Service = new() 
        {
